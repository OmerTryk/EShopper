...
{
    public class _ProductDescriptionProductDetailComponentPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _ProductDescriptionProductDetailComponentPartial(IHttpClientFactory httpClientFactory)
        {
